...
5. Use register + interfaces + connections to dispatch the target skill; skill_executor plans and invokes agent tools via dispatch.py (ungranted permissions are denied).
